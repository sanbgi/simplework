...
//
static SCtx sCtx("CPlusEquation");
class CPlusEquation : public CObject, ITensorEquation {
...
SIMPLEWORK_SINGLETON_FACTORY_AUTO_REGISTER(CPlusEquation, CPlusEquation::__getClassKey())
