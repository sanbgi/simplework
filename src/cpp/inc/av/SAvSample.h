#ifndef __SimpleWork_AV_EAvSample_H__
#define __SimpleWork_AV_EAvSample_H__
...
typedef SAvSample::EAvSampleType EAvSampleType;
typedef SAvSample::CAvSampleMeta CAvSampleMeta;


SIMPLEWORK_AV_NAMESPACE_LEAVE

#endif//__SimpleWork_AV_EAvSample_H__