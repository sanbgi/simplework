...
SIMPLEWORK_INTERFACECLASS_ENTER(MathFactory, "sw.math.MathFactory")
    ...
    SIMPLEWORK_INTERFACE_ENTER(IObject, "sw.math.ISMathFactory", 220118)
        ...
        // 构造全新的张量
        //
        virtual int createVector(STensor& spTensor, unsigned int eElementType, int nElementSize, const void* pElementData = nullptr) = 0;
        virtual int createTensor(STensor& spTensor, const SDimension& spDimVector, unsigned int eElementType, int nElementSize, const void* pElementData = nullptr ) = 0;
