...
SIMPLEWORK_INTERFACECLASS_ENTER(NnCompiledUnit, "sw.nn.NnCompiledUnit")
    ...
    SIMPLEWORK_INTERFACE_ENTER(IObject, "sw.nn.INnCompiledUnit", 211202)
        ...
        // 求偏差
        //
        virtual int devia(const STensor& spBatchIn, SNnDevia& spDevia) = 0;

        //
        // 更新权重
        //
        virtual int update(const STensor& spWeightDevia) = 0;
